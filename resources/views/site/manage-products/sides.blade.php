                ...
                <div class="col-md-12">
                    <div class="portlet box border shadow round">
                        ...
                        <div class="portlet-body">
                            <div class="portlet-body">
                                <form role="form" action="{{url('/restaurant/panel/side/insert')}}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group round">
                                                ...
                                                <input type="number" name="price" class="form-control" value=""
                                                       placeholder="قیمت وارد شود (تومان)" required>
                                            </div>
                                        </div>
                            ...
                            <table class="table table-hover table-striped" id="data-table">
                                ...
                                @foreach($sides as $side)
                                    <tr @if($side->is_available == 0) style="background: #ff6363;" @endif>
                                        <td>{{++$i}}</td>
                                        <td><img src="{{asset($side->image)}}" height="55" class="rounded float-right">
                                        </td>
                                        <td class="text-black">{{$side->name}}</td>
                                        <td class="text-black">{{number_format($side->price)}} تومان</td>
                                        @if($side->is_available == 1)
                                            <td>
                                                <a class="btn btn-warning del-edit "
                                                   href="{{url('/restaurant/panel/food/available', $side->id)}}">
                                                    تمام شد
                                                </a>
                                            </td>
                                        @else
                                        ...
                                        <td>
                                            <a class="btn btn-sm del-edit "
                                               href="{{url('/restaurant/panel/side-edit', $side->id)}}">
                                                ویرایش
                                            </a>
                                        </td>

                                        <td>
                                            <form action="{{url('/restaurant/panel/dessert/delete')}}" method="post"
