...
<head>
    ...
    <!-- Title -->
    @include('single-page.include.bootstrap')
    @include('single-page.include.nav-style-js')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
    <link rel="stylesheet" href="css/animated-tabs.css">
</head>
<body style="background: #151f33;"  >
@include('single-page.include.navigation')
@include('single-page.include.carousel')
<div class="decription-section py-2 mt-3" id="about">
    <div class="container">
        <div class="row">
	...
	-webkit-text-fill-color: transparent;text-align: center;font-size: 3rem;font-weight: 600"> کیوسک آرتا </h1>
                </h2>
                <p class=" py-3 my-2" style="font-size: 1.1rem;line-height: 2;color: #ffffff;">
                    کیوسک‌های سفارش رایانه‌های مجهز به صفحه نمایش لمسی هستند که این امکان را برای مشتریان فراهم می‌کنند تا با مشاهده تصاویر، قیمت و توضیحات گزینه‌های مختلف و مقایسه آن‌ها به جای منتظر ماندن در صف، خودشان سفارشان را در سیستم ثبت نموده و هزینه آن را توسط کارتخوان پرداخت کنند و رسید بگیرند. امروزه نیاز به تکنولوژی در جنبه‌های مختلف زندگی احساس می‌شود و مزایای مختلفی دارد. استفاده از تکنولوژی مناسب ثابت کرده است که بازدهی فعالیت اقتصادی را افزایش می‌دهد. کیوسک‌های سفارش آرتا با کیفیت ساخت بالا و قابلیت‌های ویژه از جمله‌ی این تکنولوژی‌ها هستند که مسیر را برای افزایش بازدهی فعالیت شما هموار می‌کنند.
                </p>
            </div>
        </div>
    </div>
</div>
<div class="decription-section1 py-2 mt-3" id="uses">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 py-3">
                <h2 class="mr-2 mt-2" style="text-align: center;font-weight: 600;color: white;font-size: 2.6rem">
                    کاربرد های کیوسک سفارش <h1 style="	background: linear-gradient(to right, #b33300 0%, #ff5c1a 100%);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;text-align: center;font-size: 3.6rem;font-weight: 600">   آرتا </h1>
                </h2>
                <div class="row mr-2">
                    <div class="col-md-6 text-white">
                        <ul style="direction: rtl;color: whitesmoke;font-size: 1.2rem">
                            <li class="">
                                رستوران‌ها، کافی‌شاپ‌ها و فودکورت
                            </li>
                            <li>
                                فروشگاه‌های مختلف و مراکز خرید
                            </li>
                            <li>
                                سینما و تئاتر، مراکز تفریحی و فرهنگی
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul style="direction: rtl ; color: whitesmoke;font-size: 1.2rem">
                            ...
                            <li>
                                بیمارستان‌ها، فرودگاه‌ها و ترمینال‌ها
                            </li>
                            <li>
...
<section class="tab-content">
	...
	l0.019-15.722l4.873-2.396l0.031,7.692l4.169-2.288V9.777l4.215-2.062V23.698z"></path>
        ...
        <!-- ICONS -->
        <div id="wrapper" style="border-radius: 5px">
            <div id="right-side">
                <div id="first" class="active">
                    <div class="icon">
                        {{--<svg viewBox="0 0 32 32">--}}
                            ...
                            {{--</g>--}}
                        {{--</svg>--}}
                        <i class="fa fa-list text-black text-center" style="font-size: 2.9rem"></i>
                    </div>

                    <h1 class="">سهولت انتخاب سفارش
                        برای مشتریان</h1>

                    <p class="text-right mr-3 " style="line-height: 2">نرم افزار نصب شده بر روی کیوسک‌ها با داشتن رابط کاربری بسیار کاربر پسند مشتری را در انتخاب سفارش خود یاری می‌کند</p>
                </div>
                <div id="second">
                    <div class="icon big">
                        {{--<svg viewBox="0 0 32 32">--}}
                            ...
                            {{--</g>--}}
                        {{--</svg>--}}
                        <i class="fa fa-internet-explorer text-black text-center" style="font-size: 2.9rem"></i>
                    </div>

                    <h1>مدیریت گزینه‌های منو
                        بصورت آنلاین</h1>

                    <p class="text-right mr-3" style="line-height: 2">این امکان برای مدیر سیستم فراهم است که در هر لحظه بصورت آنلاین تغییرات دلخواه را روی گزینه‌ها و نحوه سرویس‌دهی کیوسک اعمال کند</p>
                </div>
                <div id="third">
                    <div class="icon big">
                        {{--<svg viewBox="0 0 32 32">--}}
                        ...
                        {{--</g>--}}
                        {{--</svg>--}}
                        <i class="fa fa-pie-chart text-black text-center" style="font-size: 2.9rem"></i>

                    </div>
                    <h1>ارائه گزارش‌های فروش
                        بصورت آنلاین </h1>



                    <p class="text-right mr-3" style="line-height: 2">مدیر سیستم می‌تواند هر لحظه به جزئیات گزارشات فروش توسط کیوسک دسترسی داشته باشد و آن‌ها را مدیریت کند</p>

                </div>
                <div id="fourth">
                    <div class="icon big">
                        <i class="fa fa-print text-black text-center" style="font-size: 2.9rem"></i>
                    ...
                    <p class="text-right mr-3" style="line-height: 2">پرینتر کیوسک پس از پرداخت هزینه با توجه به نوع سرویس‌دهی بصورت رسید شماره نوبت و یا شماره میز را برای مشتری چاپ می‌کند</p>
                    ...
                    <li class="choose active">
                        ...
                        <div class="icon active">
                            {{--<svg viewBox="0 0 32 32">--}}
                                ...
                                {{--</g>--}}
                            {{--</svg>--}}
                            <i class="fa fa-list" style="font-size: 1.6rem"></i>

                        </div>
                    </li>
                    <li class="pay">

                        مدیریت آنلاین گزینه ها
                        <div class="icon">
                            {{--<svg viewBox="0 0 32 32">--}}
                                {{--<g filter="">--}}
                                    {{--<use xlink:href="#credit-card"></use>--}}
                                {{--</g>--}}
                            {{--</svg>--}}
                            <i class="fa fa-internet-explorer" style="font-size: 1.6rem"></i>
                        </div>
                    </li>
                    <li class="wrap">
                        ارائه گزارش‌های فروش
                        <div class="icon">
                            {{--<svg viewBox="0 0 32 32">--}}
                                {{--<g filter="">--}}
                                    {{--<use xlink:href="#gift"></use>--}}
                                {{--</g>--}}
                            {{--</svg>--}}
                            <i class="fa fa-pie-chart" style="font-size: 1.6rem"></i>
                    ...
                    <li class="ship">
                        ...
                        <div class="icon">
                            {{--<svg viewBox="0 0 32 32">--}}
                                ...
                                {{--</g>--}}
                            {{--</svg>--}}
                            <i class="fa fa-print" style="font-size: 1.6rem"></i>
                        </div>
                    </li>
        ...
        <div class="d-flex flex-row justify-content-center align-items-center mt-5 pt-3">
            <a href="{{url('ARTACatalog2019.pdf')}}" class="btn custom-btn" data-animation="fadeInUp" data-delay="700ms" style="border-radius: 8px">کاتالوگ کیوسک آرتا</a>
        </div>

    </div>
</section>
@include('single-page.include.footer')

<!-- ##### All Javascript Script ##### -->
<!-- jQuery-2.2.4 js -->
<script  src="js/animated-tabs.js"></script>
